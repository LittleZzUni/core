...
namespace JasonStorey
{
    public class Time : IComparable<Time>
    {
        ...
        public static Time TwelveHour(int hour, int minute, Meridie meridie)
        {
            return new Time(hour, minute, meridie);
        }
        ...
        {
            return TwentyFourHour(span.Hours, span.Minutes);
        }

        public static TimeSpan Difference(Time timeA, Time timeB)
        {
            return timeA.ToTimeSpan() - timeB.ToTimeSpan();
        }
        ...
        {
            return $"{Hours.ToString().PadLeft(2, '0')}:{Minutes.ToString().PadLeft(2, '0')} {Meridie}";
        }
    }
}